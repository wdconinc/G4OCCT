...
# python3 -m venv .venv-gcovr && .venv-gcovr/bin/pip install "gcovr>=5.0"
# gcovr >=5.0 is required for --exclude-throw-branches support.
...
file(
  ...
  "          --filter \"${CMAKE_SOURCE_DIR}/src/G4OCCT[^/]*\\.cc\"\n"
  "          --filter \"${CMAKE_SOURCE_DIR}/include/G4OCCT/.*\"\n"
